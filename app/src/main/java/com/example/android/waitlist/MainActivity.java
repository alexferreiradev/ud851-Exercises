...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mAdapter = new GuestListAdapter(this, cursor, cursor.getCount());
	...
	private Cursor getAllGuests(SQLiteDatabase mDb) {
		Cursor cursor = mDb.query(WaitlistContract.WaitlistEntry.TABLE_NAME, null, "", null, null, null, null, "5");
		return cursor;
	}
