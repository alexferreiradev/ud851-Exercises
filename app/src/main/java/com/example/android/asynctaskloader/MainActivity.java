...
//    private static final String SEARCH_RESULTS_RAW_JSON = "results";
    ...
    private static final int GIT_LOADER = 1;
...
//            mSearchResultsTextView.setText(rawJsonSearchResults);
        ...
        getSupportLoaderManager().initLoader(GIT_LOADER, null, MainActivity.this);
    }
...
//        new GithubQueryTask().execute(githubSearchUrl);
        ...
        Loader<String> loader = supportLoaderManager.getLoader(GIT_LOADER);
        // (23) If the Loader was null, initialize it. Else, restart it.
        if (loader == null) {
            supportLoaderManager.initLoader(GIT_LOADER, queryBundle, MainActivity.this);
        } else {
            supportLoaderManager.restartLoader(GIT_LOADER, queryBundle, MainActivity.this);
        }
    }
