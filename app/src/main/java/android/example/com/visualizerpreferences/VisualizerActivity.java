...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setColorFromPreferences(SharedPreferences sharedPreferences) {
        String colorValue = sharedPreferences.getString(getString(R.string.pref_set_color_key), getString(R.string.pref_color_red_value));
        mVisualizerView.setColor(colorValue);
    }
